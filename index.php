<?php
  ...
  if (isset($_SESSION['loggedIn'])) {
    if ($_SESSION['loggedIn']) { header('Location: dashboard.php'); exit(); }
  }
    ...
    <div class="wrapper">  <!-- wrapper begins -->
      <div class="block small center login">
          ...
          <div class="bheadl"></div>
     			...
     			<h2>Nephelai</h2>
     			<ul>
     			  <li><a href="/myr53dns/">MyR53DNS</a></li>
     			  <li><a href="login.question.php" id="login_faq" rel="facebox">?</a></li>
     			</ul>
        </div>  <!-- .block_head ends -->
        <div class="block_content">
          ...
          <p style="float:right">v<?php echo($nephelai_version); ?></p>
